...
/**
 * Cette action met à jour la propriété `form` de la page courante avec les données correspondantes, ainsi que `$page.status`.
 * En cas d'erreur, une redirection vers la page d'erreur la plus proche se produit.
